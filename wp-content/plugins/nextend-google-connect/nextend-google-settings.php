...
if (!class_exists('NextendGoogleSettings')) {
	...
	<div id="newgoogle-title"><h2>Nextend Google Connect Settings</h2></div>
        ...
        if ($newgoogle_status == 'update_success') $message = __('Configuration updated', 'nextend-google-connect') . "<br />"; else if ($newgoogle_status == 'update_failed') $message = __('Error while saving options', 'nextend-google-connect') . "<br />"; else
            $message = '';
